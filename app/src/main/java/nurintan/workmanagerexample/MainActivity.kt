package nurintan.workmanagerexample
...
import nurintan.workmanagerexample.databinding.ActivityMainBinding
        ...
        workManager.getWorkInfoByIdLiveData(id)
            .observe(this) { info ->
                ...
                if (info != null && info.state.isFinished) {
                    ...
                    activityHomeBinding.btnImageDownload.visibility =
                        View.GONE
                    activityHomeBinding.btnQueryWork.visibility =
                        View.VISIBLE

                    activityHomeBinding.downloadLayout.visibility =
                        View.VISIBLE
                    // 3
                    val message =
                        info.outputData.getString(LoopWorker.MESSAGE)
                    if (message != null) {
